...
| STUDIO-CORE-012 | Framework-specific coding assistance: completion, references, injections, line markers, navigation, inspections, intentions, quick fixes and safe refactorings | PARTIAL | Native FlowUI XML IDs, Java/Kotlin controller annotations, entity classes, nested entity properties, shared/inline fetch plans, message keys, view/screen IDs, nested menu IDs, resource/row policy targets and specific permissions now provide completion, navigation, Find Usages, project-wide cross-file rename, bidirectional controller/descriptor gutters, ambiguity diagnostics and quick fixes. Complete service/event/configuration/menu-bean/UI-component coverage, language injections, intentions and installed-IDE/heavy-fixture proof remain |
