...
| STUDIO-CORE-012 | Framework-specific coding assistance: completion, references, injections, line markers, navigation, inspections, intentions, quick fixes and safe refactorings | PARTIAL | Native FlowUI XML IDs, Java/Kotlin controller annotations, entity classes, nested entity properties and shared/inline fetch plans now provide completion, navigation, Find Usages, project-wide cross-file rename, bidirectional controller/descriptor gutters, ambiguity diagnostics and quick fixes. Complete menu/message/security/service/event/configuration coverage, language injections, intentions and installed-IDE/heavy-fixture proof remain |
