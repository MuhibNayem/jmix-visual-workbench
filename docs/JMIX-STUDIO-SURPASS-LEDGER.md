...
| CERT-KOTLIN-001 | Kotlin discovery and editing wherever Kotlin support is declared | PARTIAL | Entity generation, source-set targeting, repository generation, Kotlin schema-metadata reconstruction and revision-bound additive handwritten-entity editing now pass on both host lanes. Project-wide impact refactors for rename/type/removal and target-project semantic compilation remain |
