...
class Idea253PluginSmokeTest {

    @Test
    fun `descriptor and tool window satisfy the idea253 host contract`() {
    ...
    @Test
    fun `startup and lifecycle seams enforce the idea253 browser contract`() {
